...
class Zuck {
    constructor(stories1, param2) {
        ...
        let stories = new Zuck('stories', {
            ...
            avatars: true,        // shows user photos instead of last story item preview
            ...
            stories: [
                ...
                Zuck.buildTimelineItem(
                    ...
                    // Story items
                    [
                        // item [id, photos/video, length(sec), src, preview, link, linkText, time, seen(true/false)]
                ...
                {
                    id: "user-7",               // story id
                    photo: "assets/images/albums/05.jpg",            // story photos (or user photos)
                    ...
                    items: [              // array of items
                        // Story item
                        {
                            ...
                            type: "photo",      // photos or video
                            length: 3,          // photos timeout or video length in seconds - uses 3 seconds timeout for images if not set
                            src: "assets/images/albums/05.jpg",      // photos or video src
