 ...
 */
final class Version20231017183752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "lights" (id INT NOT NULL, user_account_id INT NOT NULL, birthday_at DATE DEFAULT NULL, deceased_at DATE DEFAULT NULL, created_at DATE NOT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) DEFAULT NULL, username VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_38BCB2E83C0C9956 ON "lights" (user_account_id)');
        $this->addSql('COMMENT ON COLUMN "lights".created_at IS \'(DC2Type:date_immutable)\'');
        $this->addSql('CREATE TABLE "messages" (id INT NOT NULL, user_account_id INT NOT NULL, light_id INT NOT NULL, message TEXT NOT NULL, created_at DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN "messages".created_at IS \'(DC2Type:date_immutable)\'');
        $this->addSql('CREATE TABLE "users" (id INT NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, created_at DATE NOT NULL, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) DEFAULT NULL, username VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id))');
